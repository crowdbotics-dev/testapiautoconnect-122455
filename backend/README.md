...
## Project Structure
    ...
    ├── testapiautoconnect_122455  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_122455`
...
2. Clone this repo and `cd testapiautoconnect_122455`
